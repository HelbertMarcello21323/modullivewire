@section('title') Create Post - Belajar Livewire 3 di XII RPL @endsection 
            ...
            <div class="card-body">
               <form wire:submit="store" enctype="multipart/form-
                  ...
                  <div class="form-group mb-4">
                     ...
                     <br> @if ($image) Image Preview: <img src="{{ $image->temporaryUrl() }}" width="250px" height="150px"> @endif
                     <!-- error message untuk title --> @error('image') 
